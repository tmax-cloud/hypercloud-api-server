...
func newClusterClaims(c *ClaimV1alpha1Client, namespace string) *clusterClaims {
...
func (c *clusterClaims) List(ctx context.Context, opts metav1.ListOptions) (result *v1alpha1.ClusterClaimList, err error) {
